...
Сортировка:
				<select name="sortname"  style="height:22; width:auto" onChange="this.form.action='merch.php?sort=1&filter=<? echo $filter;?>'; this.form.submit();" >
					...
					<option value="brand"  <? if ($fieldsort=="brand") {?> selected="selected" <? }?>>Брэнд </option>	
					<option value="sex"  <? if ($fieldsort=="sex") {?> selected="selected" <? }?>>Пол </option>	
					<option value="seasonality"  <? if ($fieldsort=="seasonality") {?> selected="selected" <? }?>>Сезонность </option>	
					<option value="capacity"  <? if ($fieldsort=="capacity") {?> selected="selected" <? }?>>Объём </option>	
...
<input   type="button"   name="button"  <? if (mysqli_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="this.form.action='updmerch.php?upd=1&step=1'; this.form.submit();" value="Редактировать">  
<input   type="button"   name="button"  <? if (mysqli_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="this.form.action='questionadmin.php?step=0'; this.form.submit();" value="Характеристика">  
<input   type="button"   name="button"  <? if (mysqli_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="this.form.action='updfile.php?upd=1&step=1'; this.form.submit();" value="Фото файлом">   
