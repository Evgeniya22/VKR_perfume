...
<?
   if ($step==1)
	...
	$Arr=$_POST['Arrsale'];
	$idsale=$Arr[0];
	$s="SELECT idsale, datesale, addressdelivery, status FROM sale WHERE idsale=$idsale";
...
$idsale =  $_REQUEST["id"];
  ...
  {//формирование SQL-запроса на добавление данных
	$s= "UPDATE sale set datedelivery='$datedelivery', addressdelivery='$addressdelivery' where idsale=$idsale";
...
<form name="form2" method="post"  enctype="multipart/form-data" >
				  <table width="422" border="0">
                    ...
                    <tr>
                      <td width="107"><font color="#000000" >   Дата доставки </font> </td>
                      <td><input   name="addressdelivery"   type="text"  value="<? echo "$f[addressdelivery]"; ?>" size="13" ></td>
                    </tr>  	                                       
                  </table>
				<br>
