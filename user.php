...
$s="select *, CONCAT (surname,' ', firstname,' ', patronymic) as fio from user where UPPER(surname)" ;
if ($value1!="Все")
...
<input   type="button"   name="button"  <? if (mysqli_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="this.form.action='upduser.php?upd=1&step=1'; this.form.submit();" value="Редактировать">  								
