...
?>  
 	...
 	$Arr=$_POST['Arrsale'];
	$idsale=$Arr[0];
		 $s="SELECT merch.idmerch, merch, category, price, countmerch FROM detail, merch, category where detail.idmerch=merch.idmerch and merch.idcategory=category.idcategory and idsale=$idsale";
