						...
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"><? echo $f["price"];?> рублей</h3>
												...
												<p class="product-category"><? echo $f["seasonality"];?>&nbsp;<? echo $f["capacity"];?></p></h4>
...
<?
$s="
SELECT CONCAT (surname,' ', firstname,' ', patronymic) as fio, response, dateresponse, mark 
FROM response, user
