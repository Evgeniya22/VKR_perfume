...
?>  
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="wishlist.php">Желания</a></li>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
          <?
		 $s="SELECT merch.idmerch, merch, category, price FROM wishlist, merch, category where wishlist.idmerch=merch.idmerch and merch.idcategory=category.idcategory and iduser=$iduser";



	 ?>        
<h3 class="breadcrumb-header">Мои желания</h3>
<br>
