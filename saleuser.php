...
?>	
	...
	//echo "UPDATE sale SET status='Продано' where idsale=$idsale";
		...
		$sort=$_GET["sort"];//считывание параметра фильтра		
		 ...
		 $s="SELECT idsale, datesale, datedelivery, status,  (select SUM(price*countmerch) from detail, merch where detail.idsale=sale.idsale and detail.idmerch=merch.idmerch) as sumsale FROM sale where sale.iduser=$iduser";
