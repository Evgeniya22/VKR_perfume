...
$step=$_REQUEST['step'];
		 ...
		 if ($step==3)
		  	  {
				 			$s="select iddetail from detail, sale, merch, category where merch.idmerch=detail.idmerch and detail.idsale=sale.idsale and merch.idcategory=category.idcategory and sale.iduser=$iduser and status='Корзина' order by iddetail";
				...
				$s="update sale set status='Заказ' where sale.iduser=$iduser and status='Корзина' ";	
...
<form name="form2"  method="post"  >
 <?
	...
	$Now=date("Y")."-".date("m")."-".date("d");   
 		 ...
 		 $s="select  CONCAT (surname,' ', firstname,' ', patronymic) as fio from user where iduser=$iduser";
  ...
  <table WIDTH=100% border=1 cellspacing=0 cellpadding=3>
      ...
      <?
		 ...
		 if ($step==2)
 		 ...
 		 $s="select merch.idmerch as idmerch, merch, category, price, countmerch from detail, sale, merch, category where merch.idmerch=detail.idmerch and detail.idsale=sale.idsale and merch.idcategory=category.idcategory and sale.iduser=$iduser and status='Корзина' order by iddetail";		
		 $r=mysqli_query($dbcnx,$s);
